  ...
  return (
    <nav>
      ...
      <div>
        ...
        {/* 👇 Show Recommendations for users with 'user' role */}
        {user?.role === "user" && (
          <Link className="underline" to="/recommendations">Recommendations</Link>
        )}

        {user?.role === "admin" && (
          <Link className="underline" to="/feedback">Feedback</Link>
        )}
